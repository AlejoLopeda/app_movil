...
const routes = [
  ...
  { path: '/monto', name: 'Monto', component: Inicialmonto, meta: { requiresAuth: true } },

  { path: '/dashboard', name: 'Dashboard', component: Dashboard, meta: { requiresAuth: true, title: 'Inicio' } },

  { path: '/ingresos', name: 'MonthlyIncomes', component: MonthlyIncomesPage, meta: { requiresAuth: true, requiresInitialAmount: true, title: 'Ingresos' } },
  { path: '/ingresos/nuevo', name: 'AddIncome', component: AddIncomePage, meta: { requiresAuth: true, requiresInitialAmount: true, title: 'Anadir ingreso' } },

  { path: '/gastos', name: 'MonthlyExpenses', component: MonthlyExpensesPage, meta: { requiresAuth: true, requiresInitialAmount: true, title: 'Gastos' } },
  { path: '/gastos/nuevo', name: 'AddExpense', component: AddExpensePage, meta: { requiresAuth: true, requiresInitialAmount: true, title: 'Anadir gasto' } },

  { path: '/historico/ingresos', name: 'HistoryIncome', component: HistoryIncomePage, meta: { requiresAuth: true, requiresInitialAmount: true, title: 'Historial Ingresos' } },
  { path: '/historico/gastos', name: 'HistoryExpense', component: HistoryExpensePage, meta: { requiresAuth: true, requiresInitialAmount: true, title: 'Historial Gastos' } },
...
router.beforeEach(async (to) => {
  ...
  if (to.meta?.requiresInitialAmount) {
    ...
    if (!d?.initial_set_at) {
      const redirect = to.fullPath && to.fullPath !== '/' ? to.fullPath : undefined
      return { name: 'Monto', query: redirect ? { redirect } : undefined }
    }
  }
